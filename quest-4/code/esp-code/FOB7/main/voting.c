...
#define HOST_IP_ADDR "192.168.2.31"        // FOB2
#define HOST_IP_ADDR_2 "192.168.2.71"      // FOB3
...
#define SERVER_IP_ADDR "96.230.59.94"      // Local RPi IP
#define PORT_2 64210                        // Port for vote communication

char *LEADER_IP_ADDR = "192.168.2.71";        // Hardcoded FOB3 IP
...
static void FL_send_task(void *pvParameters){
    ...
    while (1) {
        ...
        if(leaderID == '1'){
            LEADER_IP_ADDR = "192.168.2.31";
        }
        else if(leaderID == '2'){
            LEADER_IP_ADDR = "192.168.2.71";
        }
        else if(leaderID == '3'){
